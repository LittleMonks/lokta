 ...
 * @package lokta
 */
if( !function_exists( 'lokta_setup' ) ) :
    /**
     ...
     */
    function lokta_setup() {
        /*
         * Make theme available for translation.
         * Translations can be filed in the /languages/ directory.
         * If you're building a theme based on lokta, use a find and replace
         * to change 'lokta' to the name of your theme in all the template files.
         */
        load_theme_textdomain( 'lokta', get_template_directory() . '/languages' );
        ...
        register_nav_menus( array(
            'primary' => esc_html__( 'Primary', 'lokta' ),
        ) );
        ...
        add_theme_support( 'custom-background', apply_filters( 'lokta_custom_background_args', array(
...
add_action( 'after_setup_theme', 'lokta_setup' );
/**
 ...
 */
function lokta_content_width() {
    $GLOBALS[ 'content_width' ] = apply_filters( 'lokta_content_width', 640 );
}

add_action( 'after_setup_theme', 'lokta_content_width', 0 );
/**
 * Register widget area.
 *
 * @link https://developer.wordpress.org/themes/functionality/sidebars/#registering-a-sidebar
 */
function lokta_widgets_init() {
    register_sidebar( array(
        'name' => esc_html__( 'Sidebar', 'lokta' ),
        'id' => 'sidebar-1',
        'description' => '',
...
add_action( 'widgets_init', 'lokta_widgets_init' );
/**
...
add_action( 'wp_enqueue_scripts', 'lokta_scripts' );
